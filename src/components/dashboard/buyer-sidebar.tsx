...
const SidebarNav = ({ activePage, linksCount, onNavigate }: SidebarProps) => {
  ...
  const mainNav = [
    ...
    { icon: BarChart2, label: "Analytics", page: "analytics" as const, path: "/dashboard/buyer" },
    { icon: Megaphone, label: "Campaigns", page: "campaigns" as const, path: "/dashboard/buyer" },
  ];
  ...
  const mgmtNav = [
    ...
    { icon: Settings, label: "Brand Settings", page: "settings" as const, path: "/dashboard/buyer" },
  ];
