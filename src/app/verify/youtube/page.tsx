            ...
            <div className="space-y-4">
              {verificationStep === "initial" && !channelInfo && (
                <div className="space-y-2">
                  <h3 className="font-semibold text-lg text-pink-600 dark:text-pink-400">Channel URL</h3>
              ...
              {channelInfo && verificationStep === "initial" && !showVerificationOptions && (
                <motion.div
                ...
                >
                  ...
                  <Button onClick={startVerification} className="w-full bg-pink-600 hover:bg-pink-700">
                    Start Verification
                  </Button>
                </motion.div>
              )}
              ...
              {showVerificationOptions && (
                <motion.div
                  ...
                  className="space-y-4"
                >
                  <h3 className="font-semibold text-lg text-pink-600 dark:text-pink-400">Choose Verification Method</h3>
                  <div className="grid gap-4 md:grid-cols-2">
                    <Card 
                      ...
                      onClick={handleDescriptionVerification}
                    >
                    ...
                    >
                      <div className="space-y-4 h-full">
                        <div className="flex items-center justify-between">
                          <h4 className="font-medium text-pink-600 dark:text-pink-400">Administrative Verification</h4>
              ...
              {verificationStep === "description" && verificationCode && (
                ...
                >
                  ...
                  <Button onClick={checkVerification} className="w-full bg-pink-600 hover:bg-pink-700 text-white">
                    Check Now
                  </Button>
                </motion.div>
              )}
              ...
              {verificationStep === "checking" && verificationStatus === "pending" && (
                ...
                >
                  ...
                  <h3 className="text-xl font-medium text-pink-600">Checking your channel...</h3>
              ...
              {verificationStep === "checking" && verificationStatus === "failed" && (
                ...
                >
                  ...
                  <Button onClick={checkVerification} className="mt-4 bg-pink-600 hover:bg-pink-700">
                    Try Again
                  </Button>
                </motion.div>
              )}
