  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        console.error("Error loading influencer settings:", err);
        ...
        <main className="flex-1 overflow-y-auto p-4 lg:p-8 flex items-start justify-center">
          <div className="max-w-2xl w-full space-y-6 mt-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Manage your personal profile and display details.</p>
            </div>

            {/* Profile Identity Card */}
            <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-base font-semibold text-gray-900">Personal Identity</h2>
                {!isEditing ? (
                  <button 
              ...
              {isLoading ? (
                ...
                <div className="space-y-4">
                  <div>
                    <label className="text-xs text-gray-500 font-medium mb-1.5 block">Full Display Name</label>
                    <Input 
                  ...
                  <div>
                    <label className="text-xs text-gray-500 font-medium mb-1.5 block">Registered Account Email</label>
